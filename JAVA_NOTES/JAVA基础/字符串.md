...
```java
//统计大写、小写、数字的个数。对字符串进行遍历，再比较每个字符。
...
| public String replace(target,replacement)   | 使用新的值，替换旧值，得到新的字符串；                       |
| public String[] split(String regex)         | 根据传入的规则切割字符串，得到新的字符**数组**；             |
...
![](../图片/:Users:tyy:NOTES:JAVA_NOTES:图片::Users:tyy:Desktop:截屏2022-07-06 下午3.36.29.png)
...
![](../图片/:Users:tyy:Desktop:截屏2022-07-06 下午3.36.21.png)
